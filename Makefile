...
#
# Generated on 2026-07-28T09:02:15Z by kres 41bb496.
...
.PHONY: sign-image-talos-vmtoolsd
sign-image-talos-vmtoolsd:  ## Signs the image for talos-vmtoolsd. Requires interactive Google authentication.
	@test -n "$$GITHUB_TOKEN" || { \
	...
	@TMP=$$(mktemp -d) && trap 'rm -rf "$$TMP"' EXIT && \
	  ...
	  docker run --rm -p 127.0.0.1:8585:8585 \
	    ...
	    $(REGISTRY)/$(USERNAME)/talos-vmtoolsd:$(IMAGE_TAG)
